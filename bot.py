...
OTP_GROUP_ID = -1003964369847,-1003831889682

# ==================== WELCOME MESSAGE CONFIGURATION ====================
WELCOME_MESSAGE = """⚡ Astronet 𝗦𝗠𝗦 𝗣𝗔𝗡𝗘𝗟 𝗕𝗢𝗧 ⚡ 
━━━━━━━━━━━━━━━━━━━━━━
...
SUPPORT_LINK = "https://t.me/abirahmad1208"      # সাপোর্ট লিংক পরিবর্তনযোগ্য
                ...
                for otp in otps:
                    ...
                    if (matched_key is not None and
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ PANEL", url="https://t.me/AstronetOTP", style="primary"),
                                InlineKeyboardButton("📢 CHANNEL", url="https://t.me/freeincome032026", style="primary")
                            ]
                        ])
...
async def fast_allocate_number_multi(query, context, ranges_list, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/AstronetOTP", style="primary")]
    ])
    try:
